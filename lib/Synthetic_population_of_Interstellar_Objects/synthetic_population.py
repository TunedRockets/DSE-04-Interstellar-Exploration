...
def synthetic_population(T, rm, n0, v_min, v_max, 
                         ...
                         d_ref=1000, d=[], alpha=[], velocity_components=None):
    ...
    The input parameters define kinematics and number-density of ISOs in the interstellar space (unperturbed by the solar gravity). Besides this, the function also generates
